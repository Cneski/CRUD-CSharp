...
namespace EstoqueMercado
{
    public partial class TelaInicial : Form
    {
        ...
        private void TelaInicial_Load(object sender, EventArgs e)
        {
            ...
            bs.DataSource = DadosSingleton.Instancia().ListaProdutos;
        ...
        public void AtualizarDataGridView()
        {
            ...
            DataGrid_ListaProdutos.DataSource = DadosSingleton.Instancia().ListaProdutos;
        ...
        private void AoClicarEmDeletar(object sender, EventArgs e)
        {
            ...
            if (VerificaLinhasSelecionadas(TipoAcao))
            {
                ...
                DadosSingleton.Instancia().RemoverProduto(Indice);
        ...
        private void AoClicarEmEditar(object sender, EventArgs e)
        {
            ...
            {
                Indice = DataGrid_ListaProdutos.CurrentRow.Index;
                TelaCadastro formCadastro = new TelaCadastro(this, Indice);
                formCadastro.ShowDialog();
            }
        }
