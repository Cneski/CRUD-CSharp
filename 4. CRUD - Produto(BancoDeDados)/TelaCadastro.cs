...
namespace EstoqueMercado
{
    public partial class TelaCadastro : Form
    {
        ...
        RepositoryBancoDados Repository = new RepositoryBancoDados();

        public TelaCadastro(TelaInicial formInicial)
        {
            Inicializacao(formInicial);
            Indice = -1;
            ProdutoAtual = new Produtos();
        }

        public TelaCadastro(TelaInicial formInicial, int indice)
        {
            Inicializacao(formInicial);
            Indice = indice;
        ...
        private void Inicializacao(TelaInicial formInicial)
        {
            InitializeComponent();
        ...
        private void AoClicarEmSalvar(object sender, EventArgs e)
        {
            ...
            if (Indice >= 0)
            {
                Repository.Editar(ProdutoAtual.Id, ProdutoAtual);
            }
            else
            {
